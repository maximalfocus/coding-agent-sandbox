...
- **Codex subscription credentials are not isolated by the sidecar.** The default Codex login cache
  ...
  feasibility review — first at `0.140.0` and **re-established against the shipped `0.153.0` on
  2026-09-03** — found no supported credential-only broker: managed login
